...
// Adjust Tags -> Platform icons + Name.
// I will just use text or simple Lucide icons in a small flex.
// Wait, the user specifically mentioned Platform Icons (PC, PS, Xbox, Switch using FontAwesome). But we are bound by lucide. 
// "use Monitor for PC, Gamepad2 for PlayStation/Xbox/Switch".
